...
const DOC_REQUIRED = [
  ...
  "doc/modules/auth-session.html",
  "doc/modules/dynamic-routes.html",
  "doc/modules/collections-crud.html",
  "doc/modules/http-client.html",
  "doc/modules/pinia-state.html",
  "doc/modules/layout-shell.html",
  "doc/pages/deployment.html",
  "doc/pages/testing.html",
